...
function smarty_function_number_input($params, &$smartest_engine){
    ...
    if(isset($params['name'])){
        ...
        $smartest_engine->run(SM_ROOT_DIR.'System/Presentation/InterfaceBuilder/Inputs/numeric.tpl', array());
