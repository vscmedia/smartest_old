<?php /* Smarty version 2.6.18, created on 2007-12-01 19:09:41
         compiled from /var/www/html/System/Applications/Sets/Presentation/editSet.dynamic.tpl */ ?>
<div id="work-area">
...
" /> (<?php echo $this->_tpl_vars['set']['name']; ?>
      ...
      <tr>
        <td style="width:180px">Get <?php echo $this->_tpl_vars['model']['plural_name']; ?>
 from:</td>
        <td>
...
" <?php if ($this->_tpl_vars['site']['id'] == $this->_tpl_vars['set']['data_source_site_id']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['site']['name']; ?>
</option>
            <?php endforeach; endif; unset($_from); ?>
            <option value="ALL" <?php if ($this->_tpl_vars['set']['data_source_site_id'] == 'ALL'): ?> selected="selected"<?php endif; ?>>All Sites</option>
            <option value="CURRENT"<?php if ($this->_tpl_vars['set']['data_source_site_id'] == 'CURRENT'): ?> selected="selected"<?php endif; ?>>The site where it is used (contextual)</option>
			    </select>
        </td>
      </tr>
...
" <?php if ($this->_tpl_vars['property']['id'] == $this->_tpl_vars['set']['sort_field']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['property']['name']; ?>
</option>
            <?php endforeach; endif; unset($_from); ?>
			    </select>
			  </td>
