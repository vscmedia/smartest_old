<?php /* Smarty version 2.6.18, created on 2007-11-25 20:39:26
         compiled from /var/vsc/clients/claritycapital/smartest/System/Applications/Sets/Presentation/startPage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lower', '/var/vsc/clients/claritycapital/smartest/System/Applications/Sets/Presentation/startPage.tpl', 18, false),)), $this); ?>
<div id="work-area">
...
/editSet?set_id=<?php echo $this->_tpl_vars['set']['set_id']; ?>
'">
			<a class="option" id="item_<?php echo $this->_tpl_vars['set']['set_id']; ?>
" onclick="setSelectedItem('<?php echo $this->_tpl_vars['set']['set_id']; ?>
', 'fff');" >
			  <img border="0" src="<?php echo $this->_tpl_vars['domain']; ?>
Resources/Icons/folder.png">
			  <?php echo $this->_tpl_vars['set']['set_name']; ?>
 (<?php echo ((is_array($_tmp=$this->_tpl_vars['set']['set_type'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)); ?>
)</a></li>
...
Resources/Icons/package.png"> Browse Data in Models</a></li>
  </ul>
