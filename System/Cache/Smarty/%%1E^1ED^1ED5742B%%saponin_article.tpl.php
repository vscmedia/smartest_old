<?php /* Smarty version 2.6.18, created on 2007-12-03 13:21:53
         compiled from /var/www/html/Presentation/Masters/saponin_article.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'container', '/var/www/html/Presentation/Masters/saponin_article.tpl', 58, false),array('function', 'field', '/var/www/html/Presentation/Masters/saponin_article.tpl', 65, false),)), $this); ?>
...
Resources/Stylesheets/saponin_global_style.css" />
    <link rel="stylesheet" href="<?php echo $this->_tpl_vars['domain']; ?>
Resources/Stylesheets/saponin_article_colors.css" />
    <!--[if IE 6]>
    <link rel="stylesheet" href="<?php echo $this->_tpl_vars['domain']; ?>
...
Resources/Images/saponin_logo_article.gif" alt="Saponin, Inc" border="0" id="logo" height="116" width="279" /></a></td>
                <td>
                  <img src="<?php echo $this->_tpl_vars['domain']; ?>
Resources/Images/prairie_carnation_banner.jpg" alt="image of prairie carnations" style="display:block" />
                </td>
              </tr>
            </table>
          </div>
