<?php /* Smarty version 2.6.18, created on 2007-12-19 13:34:50
         compiled from /var/www/html/System/Applications/Pages/Presentation/editPage.form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'convert_timestamp', '/var/www/html/System/Applications/Pages/Presentation/editPage.form.tpl', 45, false),array('function', 'cycle', '/var/www/html/System/Applications/Pages/Presentation/editPage.form.tpl', 82, false),array('modifier', 'truncate', '/var/www/html/System/Applications/Pages/Presentation/editPage.form.tpl', 95, false),)), $this); ?>
...
<?php echo $this->_tpl_vars['section']; ?>
/unPublishPage?page_id=<?php echo $this->_tpl_vars['pageInfo']['webid']; ?>
'" value="Un-Publish">
    	<?php else: ?>
...
<?php echo $this->_tpl_vars['section']; ?>
/pageAssets?page_id=<?php echo $this->_tpl_vars['pageInfo']['webid']; ?>
">Go To Page Tree</a>
    	  <?php endif; ?>
    	<?php endif; ?></div>
  </div>
...
;height:20px"><td>
    		<div style="display:inline" id="siteDomainField_0">
    		  <a href="http://<?php echo $this->_tpl_vars['site']['domain']; ?>
...
" target="_blank"><?php echo ((is_array($_tmp=$this->_tpl_vars['pageUrl'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 100, "...") : smarty_modifier_truncate($_tmp, 100, "...")); ?>
</a><?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['pageUrl'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 100, "...") : smarty_modifier_truncate($_tmp, 100, "...")); ?>
<?php endif; ?></div></td>
  	    <td>
...
" target="_blank"><?php echo ((is_array($_tmp=$this->_tpl_vars['defaultUrl'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 100, "...") : smarty_modifier_truncate($_tmp, 100, "...")); ?>
</a><?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['defaultUrl'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 100, "...") : smarty_modifier_truncate($_tmp, 100, "...")); ?>
<?php endif; ?></div></td>
  	    <td></td></tr><?php endif; ?>
  	</table>
...
Resources/Images/spacer.gif" width="1" height="10" />
  ...
  <div class="edit-form-row">
    ...
    <select name="page_icon_image">
      ...
      <?php $_from = $this->_tpl_vars['available_icons']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['icon']):
?>
      <option value="<?php echo $this->_tpl_vars['icon']; ?>
"<?php if ($this->_tpl_vars['pageInfo']['icon_image'] == $this->_tpl_vars['icon']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['icon']; ?>
</option>
      <?php endforeach; endif; unset($_from); ?>
    </select>
  </div>
