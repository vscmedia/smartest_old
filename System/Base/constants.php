...
define('SM_INSTALLSTATUS_NO_CONFIG', 1);
define('SM_INSTALLSTATUS_NO_DB_CONFIG', 2);
define('SM_INSTALLSTATUS_DB_NO_CONN', 4);
define('SM_INSTALLSTATUS_DB_NONE', 8);
define('SM_INSTALLSTATUS_DB_NOT_ALLOWED', 16);
define('SM_INSTALLSTATUS_DB_NO_TABLES', 32);
define('SM_INSTALLSTATUS_DB_NO_CREATE_PERMS', 64);
define('SM_INSTALLSTATUS_NO_SITES', 128);
define('SM_INSTALLSTATUS_COMPLETE', 512);
