<h3><a href="{$domain}{$section}">Data Manager</a> > <a href="{$domain}modeltemplates/getItemVocabulary">Vocabulary</a>  > Edit {$content.vocabulary.vocabulary_name}</h3>
...
</select>(this should change the input type for default value)</td> </tr>
...
<tr><td style="width:100px" valign="top">Attribute:</td>
<td>
Name: <input type="text" name="name"> 
Value:<input type="text" name="value"> <br>(with javascript add another attribute/value)
</td>
</tr>
<tr><td style="width:100px" valign="top"></td>
<td><input type="checkbox" {if $content.itemproperty_required == "TRUE"} checked {/if}  name="schemadefinition_required" value="TRUE" />Required</td></tr>
<tr><td style="width:100px" valign="top"></td>
<td><input type="checkbox" {if $content.itemproperty_root == "TRUE"} checked {/if}  name="schemadefinition_root" value="TRUE" />Root Node</td></tr>
<tr><td style="width:100px" valign="top"></td>
<td><input type="checkbox" {if $content.itemproperty_setting == "TRUE"} checked {/if}  name="schemadefinition_setting" value="TRUE" />Setting</td></tr>
<tr>
<td>
</td>
