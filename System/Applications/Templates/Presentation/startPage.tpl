...
<div class="instruction">There are four different kinds of template. Please select which type you'd like to work with.</div>
...
<div id="actions-area">
  ...
  <ul class="actions-list" id="item-specific-actions" style="display:none">
    ...
    <li class="permament-action"><a href="#" onclick="workWithItem('listByType')" class="right-nav-link"><img src="{$domain}Resources/Icons/page_add.png" /> Browse these templates</a></li>
