<div id="work-area">
  ...
  <div>
    ...
    <p style="margin-top:15px"><strong>Want to give Smartest's developers some props?</strong> just put <code>&lt;?sm:sm:?&gt;</code> in a template to make: <a href="http://sma.rte.st"><img src="{$domain}Resources/System/Images/smartest_credit_button.png" /></a></p>
