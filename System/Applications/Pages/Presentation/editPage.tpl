...
<div id="actions-area">
  <ul class="actions-list" id="non-specific-actions">
    ...
    <li class="permanent-action"><a href="{$domain}{$section}/editSite?site_id={$pageInfo.site_id}" class="right-nav-link"><img src="{$domain}Resources/Icons/layout_edit.png" border="0" alt=""> Edit Site Parameters</a></li>
