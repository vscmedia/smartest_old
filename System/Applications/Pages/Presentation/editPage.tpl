...
<div id="actions-area">
  <ul class="actions-list" id="non-specific-actions">
    ...
    <li class="permanent-action"><a href="{$domain}{$section}/publishPageConfirm?page_id={$pageInfo.webid}" class="right-nav-link"><img src="{$domain}Resources/Icons/page_lightning.png" border="0" alt=""> Publish this page</a></li>
