<div id="work-area">
  ...
  <form action="{$domain}{$section}/insertTodoItem" method="post">
    ...
    <div class="edit-form-row">
      ...
      {$asset.stringid}{if $asset.full_path} ({$asset.full_path}){/if}
    </div>
    
    <div class="edit-form-row">
      <div class="form-section-label">Who is this task for?</div>
    ...
    <div class="edit-form-row">
      ...
      <select name="todoitem_type">
        <option value="SM_TODOITEMTYPE_EDIT_ASSET">Edit this file</option>
        <option value="SM_TODOITEMTYPE_APPROVE_ASSET">Approve this file</option>
      </select>
    </div>
