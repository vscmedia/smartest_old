...
<?sm:_asset_from_object object=$_textattachment.asset_object style="margin:5px;":?>
<?sm:else:?>
<?sm:_asset_from_object object=$_textattachment.asset_object style="margin:5px 0 5px 0;":?>
<?sm:/if:?>
