<ul class="tabset">
    ...
    {if $can_edit_properties}<li{if $method == "editItemClassPropertyOrder"} class="current"{/if}><a href="{$domain}datamanager/editItemClassPropertyOrder?class_id={$model.id}">Edit property order</a></li>{/if}
</ul>