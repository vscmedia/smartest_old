...
class SmartestDataUtility{
    ...
    static function loadTypeObjects(){
		...
		// find the helpers if this hasn't already been done
		if(!is_array($available_objects) || !is_file(SM_ROOT_DIR.'System'.DIRECTORY_SEPARATOR.'Cache'.DIRECTORY_SEPARATOR.'Includes'.DIRECTORY_SEPARATOR.'SmartestTypeObjects.cache.php')){
			...
			if($res = opendir(SM_ROOT_DIR.'System'.DIRECTORY_SEPARATOR.'Data'.DIRECTORY_SEPARATOR.'Types'.DIRECTORY_SEPARATOR)){
				...
				// SmartestCache::save('smartest_available_type_objects', $object_types, -1, true);
