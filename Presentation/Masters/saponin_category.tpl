...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="{$domain}Resources/Stylesheets/saponin_category_colors.css" />
    <!--[if IE 6]>
        ...
        <div id="fixed-width-container-inner">
          ...
          <div id="logo-banner" onmouseover="hideAllMenus()">
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td><a href="/"><img src="{$domain}Resources/Images/saponin_logo_category.gif" alt="Saponin, Inc" border="0" id="logo" height="116" width="279" /></a></td>
                <td>
                  <img src="{$domain}Resources/Images/multicolor_banner.jpg" alt="" style="display:block">
                </td>
              </tr>
            </table>
          </div>
